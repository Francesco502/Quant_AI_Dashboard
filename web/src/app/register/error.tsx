  ...
  return (
    <div className="glass-card mx-auto flex min-h-[320px] max-w-md flex-col items-center justify-center rounded-[30px] px-8 text-center" role="alert">
      ...
      <p className="mt-2 max-w-md text-sm leading-7 text-muted-foreground">
        {error.message || "注册页面渲染时遇到错误。"}
      </p>
      <div className="mt-6 flex items-center gap-3">
        <button onClick={reset} className="inline-flex items-center gap-2 rounded-2xl border border-[rgba(var(--rgb-ochre),0.18)] bg-[rgba(var(--rgb-ochre),0.08)] px-5 py-2.5 text-sm font-medium text-[rgb(var(--rgb-ochre))] transition-all hover:bg-[rgba(var(--rgb-ochre),0.14)]">
